...
- `PREMIUM_SILENCING`: fade de 1,5 segundos; el restaurado final vive en un `finally`. La celebración audiovisual es independiente y continúa hasta completar sus 15 segundos aunque el estado ya sea `SILENCED`; los cinco festejos dejan silencios reales entre sí y, al salir, reiniciar o restablecer Premium, se detienen inmediatamente.
