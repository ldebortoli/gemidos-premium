...
android {
    ...
    defaultConfig {
        applicationId = "com.gemidospremium.app"
        minSdk = 24
        targetSdk = 36
        ...
        buildConfigField("String", "PREMIUM_PRODUCT_ID", "\"premium_silence_pack\"")
    }
...
val coverageSources = files("src/main/java/com/gemidospremium/app/domain")
...
if (playTaskRequested && (playAdMobAppId.isBlank() || playBannerId.isBlank())) {
    throw GradleException(
        "La variante Play exige GEMIDOSPREMIUM_ADMOB_APP_ID y GEMIDOSPREMIUM_ADMOB_BANNER_ID en ~/.gradle/gradle.properties.",
    )
}
